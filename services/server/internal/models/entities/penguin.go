...
type PenguinZone string

const (
	PenguinZoneMap   PenguinZone = "map"
	PenguinZoneStage PenguinZone = "stage"
)
...
type Penguin struct {
	...
	StagePosition   Position    `json:"stage_position"`
	Zone            PenguinZone `json:"zone"`
	...
	PublicDirection float64     `json:"public_direction"`
